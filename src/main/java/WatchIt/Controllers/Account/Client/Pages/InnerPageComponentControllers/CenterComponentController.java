...
public class CenterComponentController {
    public FontAwesomeIconView Backward,Sound;
    public AnchorPane ControlBar;
    public FontAwesomeIconView Forward;
    public MediaView MediaContiner;
    public FontAwesomeIconView Play;
    public Text time;
    ...
    public void initialize() {
        ...
        TimeSlider.valueProperty().addListener((observable, oldValue, newValue) -> {
            ...
            String style = String.format("-fx-background-color: linear-gradient(to right, #f47d05 %d%%, #969696 %d%%);",
                    newValue.intValue(), newValue.intValue());
            tim.setStyle(style);
        });
    }

    public void ShowingBar(MouseEvent event) {
...
//        if(Play.getText().charAt(0)==FontAwesomeIcon.PLAY.getChar()){
//            mediaPlayer.play();
...
//        }
    ...
    public void Up10Sec(MouseEvent event) {
        mediaPlayer.seek(mediaPlayer.getCurrentTime().add(Duration.seconds(10)));
    }

    public void Down10Sec(MouseEvent event) {
